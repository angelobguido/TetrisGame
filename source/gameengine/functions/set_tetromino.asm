...
mul CHOSEN_TETROMINO_ADRESS, SELECTED_TETROMINO, TETROMINO_SIZE
...
mul SELECTED_ROTATION, SELECTED_ROTATION, PIXEL_ARRAY_SIZE
...
loadi CURRENT_PIXEL_POSITION, CHOSEN_TETROMINO_ADRESS ;Get the position in the adress
storei GAME_TETROMINO_ADRESS, CURRENT_PIXEL_POSITION ;Put position in another adress
